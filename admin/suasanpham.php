      ...
      <div class='bg-white p-6 rounded-lg shadow-lg'>
        ...
        <form action='' method='POST' enctype='multipart/form-data'>
          ...
          <div class='mb-4'>
            ...
            <textarea id='product_description' name='product_description' class='w-full p-3 border border-gray-300 rounded-md' required>
            ...
            <select name='catagory_id' id='catagory_id' class='w-full p-3 border border-gray-300 rounded-md'
              ...
              <?php foreach ($lstCatagory as $catagory) { ?>
                <option
                  ...
                  value='<?php echo $catagory['catagory_id']; ?>'><?php echo $catagory['name']; ?></option>
              <?php } ?>
            </select>
          </div>
          ...
          <div id='optionsContainer'>
            ...
            ?>
              <div class='flex space-x-2 mb-4'>
                <input type='hidden' name='product_detail_id[]' value='<?php echo $productDetail['product_detail_id']; ?>' />
                <div class='w-1/4'>
                  <label for='colorSelect' class='block text-sm font-medium text-gray-700'>Chọn màu sắc</label>
                  <select id='colorSelect' name='colors[]' class='w-full p-3 border border-gray-300 rounded-md' required>
                    ...
                    <?php foreach ($allColors as $color) { ?>
                      <option
                        ...
                        value='<?php echo $color['color_id']; ?>'><?php echo $color['color_name']; ?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class='w-1/4'>
                  ...
                  <select id='sizeSelect' name='sizes[]' class='w-full p-3 border border-gray-300 rounded-md' required>
                    ...
                    <?php foreach ($allSizes as $size) { ?>
                      <option
                        ...
                        value='<?php echo $size['size_id']; ?>'><?php echo $size['size_code']; ?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class='w-1/4'>
                  <label for='quantities' class='block text-sm font-medium text-gray-700'>Số lượng</label>
                  <input type='number' id='quantities' name='quantities[]' class='w-full p-3 border border-gray-300 rounded-md' min='1'
          ...
          <div class='mb-4'>
            <label for='image_url' class='block text-sm font-medium text-gray-700'>Upload hình ảnh mới</label>
            <input multiple type='file' id='image_url' name='image_url[]' class='w-full p-3 border border-gray-300 rounded-md'>
          </div>

          <div class='flex justify-between items-center'>
            <a href='index.php?page=qlsanpham' class='bg-red-500 text-white px-6 py-2 rounded-md hover:bg-red-700 mr-4'>Quay lại</a>
